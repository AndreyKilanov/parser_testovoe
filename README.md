# Парсер сайта maksavit.ru (тестовое задание)
...
На вход подается список категорий (минимум 3), с количеством товаров от 50 штук на категорию (более 3 страниц в одной категории) 
на сайте maksavit.ru (Например: https://maksavit.ru/catalog/materinstvo_i_detstvo/detskaya_gigiena/)

Обязательно осуществлять сбор данных с учетом выбранного региона для парсинга - Новосибирск
...
```
Результаты будут находиться `/src/data/maksavit.json`
